...
// UPSTATE: "Backporting" this idea from San Andreas, as it's only about nearby peds anyway
GET_RANDOM_CHAR_IN_ZONE CITYZON taxi_ped1
...
WAIT 0
	...
	IF IS_COLLISION_IN_MEMORY LEVEL_SUBURBAN
		IF NOT IS_PLAYER_IN_ZONE player UL_ZON0 //SUBURBIA*******************************************
		...
		ELSE
			IF NOT IS_PLAYER_IN_ZONE player GT_ZON0 //UPSTATE COUNTRYSIDE*******************************************
