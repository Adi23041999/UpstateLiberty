...
//WARP_PLAYER_INTO_CAR Player boat_mar // SCFIX: moved down
...
SWITCH_RUBBISH ON
CLEAR_CUTSCENE
IF NOT IS_CAR_DEAD boat_mar // SCFIX
	WARP_PLAYER_INTO_CAR Player boat_mar // SCFIX: moved here from above
ENDIF // SCFIX
